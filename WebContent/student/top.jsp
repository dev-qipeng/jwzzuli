				...
				<table width="750" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right" height="26"
							...
							class="username"><s:property value="#session.username" /></span>，欢迎登录教务管理系统！
							[<a href="<%=request.getContextPath()%>/index.jsp"
							target="_blank">登录页面</a>] [<a href="stuinfo/updatePwd.jsp" target="main">修改密码</a>]
							[<a href="<%=request.getContextPath()%>/index.jsp" target="_top">注销退出</a>]&nbsp;
						</td>
					</tr>
					<tr>
							...
							<dl id="tpa">
								<dd class='img'>
									<a href="javascript:ChangeMenu(-1);"><img vspace="5"
										src="skin/images/frame/arrl.gif" border="0" width="5"
										height="8" alt="缩小左框架" title="缩小左框架" /></a>
								</dd>
								<dd class='img'>
									<a href="javascript:ChangeMenu(0);"><img vspace="3"
										src="skin/images/frame/arrfc.gif" border="0" width="12"
										height="12" alt="显示/隐藏左框架" title="显示/隐藏左框架" /></a>
								</dd>
								<dd class='img' style="margin-right: 10px;">
									<a href="javascript:ChangeMenu(1);"><img vspace="5"
										src="skin/images/frame/arrr.gif" border="0" width="5"
										height="8" alt="增大左框架" title="增大左框架" /></a>
								</dd>
								<dd>
									<div class='itemsel' id='item1'
										onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);">
										<a href="menu.jsp" onclick="changeSel(1)" target="menu">主菜单</a>
									</div>
								</dd>
